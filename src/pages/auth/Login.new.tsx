  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden -z-10">
        <div className="absolute top-0 right-0 w-[70%] h-[70%] rounded-full bg-primary/5 blur-3xl" />
        <div className="absolute bottom-0 left-0 w-[70%] h-[70%] rounded-full bg-accent/5 blur-3xl" />
      </div>
